    ...
    <div class="container" style="width: 40%; text-align: left">
        <div id="pilgrimDetails">
            ...
            <div id="paymentDetails" style="text-align: center; width: 80%; padding: 5px; margin: 0px auto;">
                ...
                <h2><asp:Localize runat="server" ID="Method_txt" Text="Payment Method" meta:resourcekey="Method_txt" /></h2>

                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label><asp:Localize runat="server" ID="Card_txt" Text="Payment Card" meta:resourcekey="Card_txt" /></label>
                    </div>
                </div>
                ...
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label><asp:Localize runat="server" ID="Number_txt" Text="Card Number" meta:resourcekey="Number_txt" /></label>
                    </div>
                </div>
                ...
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label><asp:Localize runat="server" ID="Expiration_txt" Text="Expiration date and security code" meta:resourcekey="Expiration_txt" /></label>
                    </div>
                </div>
                <div class="Row">
                ...
                <h2><asp:Localize runat="server" ID="Information_txt" Text="Billing Information" meta:resourcekey="Information_txt" /></h2>

                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label><asp:Localize runat="server" ID="Name_txt" Text="Full name" meta:resourcekey="Name_txt" /></label>
                    </div>
                </div>
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label><asp:Localize runat="server" ID="City_txt" Text="City" meta:resourcekey="City_txt" /></label>
                    </div>
                </div>
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label><asp:Localize runat="server" ID="Address_txt" Text="Billing address" meta:resourcekey="Address_txt" /></label>
                    </div>
                </div>
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-2 col-xs-12">
                        <label><asp:Localize runat="server" ID="Zip_txt" Text="Zip or postal code" meta:resourcekey="Zip_txt" /></label>
                    </div>
                </div>
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-2 col-xs-12">
                        <label><asp:Localize runat="server" ID="Currency_txt" Text="Currency" meta:resourcekey="Currency_txt" /></label>
                    </div>
                </div>
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-2 col-xs-12">
                        <label><asp:Localize runat="server" ID="Phone_txt" Text="Phone number" meta:resourcekey="Phone_txt" /></label>
                    </div>
                </div>
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div id="paymentRequirements" style="text-align: center; width: 80%; padding: 5px; margin: 0px auto;">
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-2 col-xs-12">
                        <label><asp:Localize runat="server" ID="ID_txt" Text="Pilgrim ID of the receiver" meta:resourcekey="ID_txt" /></label>
                    </div>
                </div>
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-2 col-xs-12">
                        <label><asp:Localize runat="server" ID="Money_txt" Text="How much money do you want to send" meta:resourcekey="Money_txt" /></label>
                    </div>
                </div>
                <div class="Row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
